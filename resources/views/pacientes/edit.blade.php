...
@section('content')
  ...
  <div class="box box-default">
        ...
        @include('flash::message')
          <div class="row">
           {!! Form::open(['class' => '','method' => 'PUT','route' => ['pacientes.update',$user],'role' => 'form','files' => true]) !!}
	            ...
	            <div class="col-md-12">
	            	<div class="form-group col-md-4">
	            	  {!! Form::label('paisresidencia_id','País Residencia') !!}
	                   {!! Form::select('paisresidencia_id',$paises, $residencia->departamento->pais->id,['class' => 'form-control','style' => 'width: 100%']) !!}
	                </div>

	                <div class="form-group col-md-4">
	            	  {!! Form::label('departamentoresidencia_id','Departamento Residencia') !!}
	                  {!! Form::select('departamentoresidencia_id',$departamentoresidencias, $residencia->departamento->id,['class' => 'form-control','style' => 'width: 100%']) !!}
	                </div>
	            
	            	<div class="form-group col-md-4">
	            	  {!! Form::label('municipioresidencia_id','Municipio Residencia') !!}
	                  {!! Form::select('municipioresidencia_id',$municipioresidencias, $residencia->id,['class' => 'form-control','style' => 'width: 100%']) !!}
	                </div>
	              <!-- /.form-group -->
	            </div>
	            ...
	            <div class="col-md-12">
		            <div class="form-group col-md-4">
		                {!! Form::label('empresa_id','EPS') !!}
		                 {!! Form::select('empresa_id',$empresas, $user->paciente->empresa_id,['class' => 'form-control select2','style' => 'width: 100%','data-placeholder' => 'Seleccione' ]) !!}
		              	</div>
		        
		            <div class="form-group col-md-4">
		                {!! Form::label('arl_id','ARL') !!}
		                 {!! Form::select('arl_id',$arls, $user->paciente->arl_id,['class' => 'form-control select2','style' => 'width: 100%','data-placeholder' => 'Seleccione' ]) !!}
		              	</div>
		        
		            <div class="form-group col-md-4">
		                {!! Form::label('afp_id','AFP') !!}
		                 {!! Form::select('afp_id',$afps, $user->paciente->afp_id,['class' => 'form-control select2','style' => 'width: 100%','data-placeholder' => 'Seleccione' ]) !!}
		              	</div>
		        </div>
