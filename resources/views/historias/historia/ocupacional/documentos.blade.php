        ...
        <div class="box-body">
            ...
            <div class="row">
               <div class="col-md-12">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a data-toggle="modal" data-url="{{ route('historias.ocupacional.documentos.destroy',[$paciente->id,$historia_ocupacional->id,Crypt::encrypt($file['ruta']) ]) }}" class="open-modal" href="#myAlert"><span class="label label-danger">Eliminar</span></a>
                ...
                {!! Form::open(['class' => '','method' => 'POST','route' => ['historias.ocupacional.documentos.store',$paciente->id,$historia_ocupacional->id],'role' => 'form','files' => true]) !!}
