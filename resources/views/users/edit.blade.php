...
@section('content')
  ...
  <div class="box box-default">
        ...
        @include('flash::message')
          <div class="row">
           {!! Form::open(['class' => '','method' => 'PUT','route' => ['users.update',$user],'role' => 'form','files' => true]) !!}
               	<div class="col-md-12">
	            ...
	            <div class="col-md-12">
 				...
 				<div class="col-md-12">
	                ...
	                {!! Form::label('roles','Roles de Usuario') !!}
	                 {!! Form::select('roles[]',$roles, $user_role,['class' => 'form-control select2','style' => 'width: 100%','data-placeholder' => 'Seleccione','multiple' => 'true' ]) !!}
