...
@section('content-header')
     <h1>
        Asistentes
        <small>Mostrar información del asistente</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ route('home') }}"><i class="fa fa-home"></i> Escritorio</a></li>
        <li><a href="{{ route('asistentes.index') }}">Asistentes</a></li>
        <li class="active">Mostrar información del asistente</li>
      </ol>
@endsection
	             ...
	             <div class="col-md-12">
  	               ...
  	               <div class="form-group col-md-12">
  	                {!! Form::label('medicos','Medicos') !!}
  	                 {!! Form::select('medicos[]',$medicos, $asistente_medico,['class' => 'form-control select2','style' => 'width: 100%','data-placeholder' => '','multiple' => 'true' ,'disabled'=>'disabled']) !!}
  	              	</div>
	              <!-- /.form-group -->
              </div>
