...
@section('content-header')
     <h1>
        Asistentes
        <small>Crear nuevo asistente</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ route('home') }}"><i class="fa fa-home"></i> Escritorio</a></li>
        <li><a href="{{ route('asistentes.index') }}">Asistentes</a></li>
        <li class="active">Crear nuevo asistente</li>
      </ol>
@endsection
  ...
  <div class="box box-default">
        <div class="box-header with-border">
			<div class="box-header">
				  <a href="{{ route('asistentes.index') }}"><button type="submit" class="btn btn-default btn-sm">Ver lista de asistentes</button></a>
			</div>
        ...
        @include('flash::message')
          <div class="row">
          	{!! Form::open(['class' => '','method' => 'POST','route' => 'asistentes.store','role' => 'form','files' => true]) !!}
	           ...
	           <div class="col-md-12">
  	               ...
  	               <div class="form-group col-md-12">
  	                {!! Form::label('medicos','Medicos') !!}
  	                 {!! Form::select('medicos[]',$medicos, '',['class' => 'form-control select2','style' => 'width: 100%','data-placeholder' => 'Seleccione','multiple' => 'true' ]) !!}
  	              	</div>
	              <!-- /.form-group -->
              </div>
