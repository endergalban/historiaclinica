...
@section('content-header')
     <h1>
        Especialidades
        <small>Editar especialidad</small>
      </h1>
      <ol class="breadcrumb">
...
@section('content')
  ...
  <div class="box box-default">
        ...
        @include('flash::message')
          <div class="row">
           {!! Form::open(['class' => '','method' => 'PUT','route' => ['especialidades.update',$especialidad],'role' => 'form']) !!}
               	  
	            <div class="col-md-12">
	                <div class="form-group col-md-9">
	            	  {!! Form::label('descripcion','Descripción') !!}
	                  {!! Form::text('descripcion',$especialidad->descripcion,['placeholder' => '','class'=>'form-control']) !!}
	                </div>
	              <!-- /.form-group -->
	            </div>
