...
*/
    ...
    public function menu($id){
        ...
        $result = $this->modulos()->select('modulos.orden as orden','modulos.icono as icono','modulos.descripcion as descripcion','modulos.site as site')->where('users.id', $id)->orderBy('orden', 'asc')->get();
        return $result;
    }
